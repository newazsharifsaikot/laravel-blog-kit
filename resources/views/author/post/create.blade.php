                    ...
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="title" id="Title" class="form-control @error('title') is-invalid @enderror" placeholder="Enter Post title" value="{{ old('title') }}" autocomplete="title" autofocus>
                                    </div>
                                    @error('title')
                                ...
                                <div class="form-group">
                                    <input type="checkbox" name="status" id="statuss" class="filled-in" value="true">
                                    <label for="statuss">Publish</label>
                                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <a href="{{route('author.post')}}" class="btn btn-danger btn-sm m-t-15 waves-effect">Back</a>
                        </div>
                    </div>
                </div>
            </div>

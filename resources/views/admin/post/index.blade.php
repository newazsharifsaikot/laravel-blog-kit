...
@section("content")
    <div class="container-fluid">
        <div class="block-header">
            <a href="{{route('admin.post.create')}}" class="btn btn-primary btn-sm waves-effect">
                                ...
                                @foreach($posts as $key=>$post)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            @if($post->status == true)
                                                <a href="{{route('admin.post.pending',$post->id)}}" class="btn btn-danger btn-sm waves-effect pull-right" title="Pending" onclick="return confirm('Are you Sure ?') ">
                                                    <i class="material-icons">clear</i>
                                                </a>
                                             @else
                                                <a href="{{route('admin.post.publish',$post->id)}}" class="btn btn-success btn-sm waves-effect pull-right" title="Publish" onclick="return confirm('Are you Sure ?') ">
                                                    <i class="material-icons">done</i>
                                                </a>
                                            @endif

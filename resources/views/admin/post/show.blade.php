...
@section("content")
    <div class="container-fluid">
        <div class="block-header">
            <a href="{{route('admin.post')}}" class="btn btn-primary waves-effect btn-sm">Back</a>

            @if($post->is_approve == false)
                <button class="btn btn-success btn-sm waves-effect pull-right" onclick="approvePost()">
